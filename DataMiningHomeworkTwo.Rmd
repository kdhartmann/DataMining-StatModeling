...
out_of_sample = round(((topleft+bottomright)/(topright+bottomright+topleft+bottomleft))*100, 2)
...
out_of_sample1 = round(((topleft1+bottomright1)/(topright1+bottomright1+topleft1+bottomleft1))*100 ,2)
